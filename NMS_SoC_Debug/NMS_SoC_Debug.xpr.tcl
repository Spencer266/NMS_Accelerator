...
#
# NMS_SoC_Debug.xpr.tcl: Tcl script for re-creating project 'NMS_SoC_Debug'
#
# Generated by Vivado on Mon Dec 09 19:19:52 +07 2024
...
#
# 1. This project restoration tcl script (NMS_SoC_Debug.xpr.tcl) that was generated.
#
...
set _xil_proj_name_ "NMS_SoC_Debug"
...
set script_file "NMS_SoC_Debug.xpr.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../NMS_SoC_Debug"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../NMS_SoC_Debug/NMS_SoC_Debug.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
